...
Improvements
  ...
  - Testing / Media Integration: Added isolated FFmpeg integration coverage for segmented images and single-image multi-audio renders without touching user AppData.
